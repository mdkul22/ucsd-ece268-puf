...
#ifndef _puf_axi_interface_HH_
#define _puf_axi_interface_HH_

#include "systemc.h"
#include "AESL_pkg.h"

#include "puf_axi_interface_AXILiteS_s_axi.h"

namespace ap_rtl {

template<unsigned int C_S_AXI_AXILITES_ADDR_WIDTH = 7,
         unsigned int C_S_AXI_AXILITES_DATA_WIDTH = 32>
struct puf_axi_interface : public sc_module {
    ...
    // Module declarations
    puf_axi_interface(sc_module_name name);
    SC_HAS_PROCESS(puf_axi_interface);
    ...
    puf_axi_interface_AXILiteS_s_axi<C_S_AXI_AXILITES_ADDR_WIDTH,C_S_AXI_AXILITES_DATA_WIDTH>* puf_axi_interface_AXILiteS_s_axi_U;
