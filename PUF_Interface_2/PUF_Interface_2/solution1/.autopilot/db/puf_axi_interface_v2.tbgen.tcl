set C_TypeInfoList {{ 
"puf_axi_interface_v2" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"challenge1axi": [[],"0"] }, {"challenge2axi": [[],"0"] }, {"responseaxi": [[],{ "pointer": "1"}] }, {"tuneraxi": [[],"2"] }, {"challenge1in": [[],{ "pointer": "0"}] }, {"challenge2in": [[],{ "pointer": "0"}] }, {"responsein": [[],"1"] }, {"tuner": [[],{ "pointer": "2"}] }, {"output1axi": [[],{ "pointer": "1"}] }, {"output2axi": [[],{ "pointer": "1"}] }, {"outputin1": [[],"1"] }, {"outputin2": [[],"1"] }, {"startin": [[],{ "pointer": "3"}] }, {"startaxi": [[],"3"] }],[],""], 
...
set moduleName puf_axi_interface_v2
...
set C_modelName {puf_axi_interface_v2}
...
set C_modelArgMapList {[ 
	{ "Name" : "challenge1axi_V", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_none","bitwidth" : 4, "direction" : "READONLY", "bitSlice":[{"low":0,"up":3,"cElement": [{"cName": "challenge1axi.V","cData": "uint4","bit_use": { "low": 0,"up": 3},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":16}, "offset_end" : {"in":23}} , 
 	...
 	{ "Name" : "tuneraxi_V", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_none","bitwidth" : 5, "direction" : "READONLY", "bitSlice":[{"low":0,"up":4,"cElement": [{"cName": "tuneraxi.V","cData": "uint5","bit_use": { "low": 0,"up": 4},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":40}, "offset_end" : {"in":47}} , 
 	...
 	{ "Name" : "tuner_V", "interface" : "wire", "bitwidth" : 5, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":4,"cElement": [{"cName": "tuner.V","cData": "uint5","bit_use": { "low": 0,"up": 4},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "output1axi_V", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_vld","bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "output1axi.V","cData": "uint8","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":48}, "offset_end" : {"out":55}} , 
 	{ "Name" : "output2axi_V", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_vld","bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "output2axi.V","cData": "uint8","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":56}, "offset_end" : {"out":63}} , 
 	...
 	{ "Name" : "startaxi_V", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_none","bitwidth" : 1, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "startaxi.V","cData": "uint1","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":64}, "offset_end" : {"in":71}} ]}
...
set portList { 
	...
	{ tuner_V sc_out sc_lv 5 signal 7 } 
...
set NewPortList {[ 
	{ "name": "s_axi_AXILiteS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "AXILiteS", "role": "AWADDR" },"address":[{"name":"puf_axi_interface_v2","role":"start","value":"0","valid_bit":"0"},{"name":"puf_axi_interface_v2","role":"continue","value":"0","valid_bit":"4"},{"name":"puf_axi_interface_v2","role":"auto_start","value":"0","valid_bit":"7"},{"name":"challenge1axi_V","role":"data","value":"16"},{"name":"challenge2axi_V","role":"data","value":"24"},{"name":"tuneraxi_V","role":"data","value":"40"},{"name":"startaxi_V","role":"data","value":"64"}] },
	...
	{ "name": "s_axi_AXILiteS_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "AXILiteS", "role": "ARADDR" },"address":[{"name":"puf_axi_interface_v2","role":"start","value":"0","valid_bit":"0"},{"name":"puf_axi_interface_v2","role":"done","value":"0","valid_bit":"1"},{"name":"puf_axi_interface_v2","role":"idle","value":"0","valid_bit":"2"},{"name":"puf_axi_interface_v2","role":"ready","value":"0","valid_bit":"3"},{"name":"puf_axi_interface_v2","role":"auto_start","value":"0","valid_bit":"7"},{"name":"responseaxi_V","role":"data","value":"32"}, {"name":"responseaxi_V","role":"valid","value":"36","valid_bit":"0"},{"name":"output1axi_V","role":"data","value":"48"}, {"name":"output1axi_V","role":"valid","value":"52","valid_bit":"0"},{"name":"output2axi_V","role":"data","value":"56"}, {"name":"output2axi_V","role":"valid","value":"60","valid_bit":"0"}] },
	...
	{ "name": "interrupt", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "AXILiteS", "role": "interrupt" } }, 
 	...
 	{ "name": "tuner_V", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "tuner_V", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.puf_axi_interface_v2_AXILiteS_s_axi_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	tuner_V { ap_vld {  { tuner_V out_data 1 5 }  { tuner_V_ap_vld out_vld 1 1 } } }
