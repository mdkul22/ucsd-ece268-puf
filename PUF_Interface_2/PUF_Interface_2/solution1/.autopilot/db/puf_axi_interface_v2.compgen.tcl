...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 1 \
			corename puf_axi_interface_v2_AXILiteS_axilite \
			name puf_axi_interface_v2_AXILiteS_s_axi \
			ports {$port_AXILiteS} \
			op interface \
		} "
	} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler puf_axi_interface_v2_AXILiteS_s_axi
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_tuner_V \
    op interface \
    ports { tuner_V { O 5 vector } tuner_V_ap_vld { O 1 bit } } \
} "
}
