...
HD_PWD='C:/Users/Mayunk/Desktop/ECE268/long_puf/long_puf.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log long_puf_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source long_puf_wrapper.tcl
