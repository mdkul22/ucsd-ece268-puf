...
HD_PWD='C:/Users/Mayunk/Desktop/ECE268/long_puf/long_puf.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log long_puf_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source long_puf_wrapper.tcl -notrace
