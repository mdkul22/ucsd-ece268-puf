...
HLS_SOURCES = ../../../test.cpp ../../../long_puf_axi_interface.cpp
...
$(ObjDir)/long_puf_axi_interface.o: ../../../long_puf_axi_interface.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../long_puf_axi_interface.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/long_puf_axi_interface.d
