...
`timescale 1ns/1ps
module long_puf_axi_interface_AXILiteS_s_axi
#(parameter
    ...
    output wire [31:0]                   tuneraxi_top_1_V,
    output wire [31:0]                   tuneraxi_top_2_V,
    output wire [31:0]                   tuneraxi_top_3_V,
    output wire [31:0]                   tuneraxi_top_4_V,
    output wire [31:0]                   tuneraxi_btm_1_V,
    output wire [31:0]                   tuneraxi_btm_2_V,
    output wire [31:0]                   tuneraxi_btm_3_V,
    output wire [31:0]                   tuneraxi_btm_4_V,
...
localparam
    ...
    ADDR_TUNERAXI_TOP_1_V_DATA_0 = 7'h28,
    ADDR_TUNERAXI_TOP_1_V_CTRL   = 7'h2c,
    ADDR_TUNERAXI_TOP_2_V_DATA_0 = 7'h30,
    ADDR_TUNERAXI_TOP_2_V_CTRL   = 7'h34,
    ADDR_TUNERAXI_TOP_3_V_DATA_0 = 7'h38,
    ADDR_TUNERAXI_TOP_3_V_CTRL   = 7'h3c,
    ADDR_TUNERAXI_TOP_4_V_DATA_0 = 7'h40,
    ADDR_TUNERAXI_TOP_4_V_CTRL   = 7'h44,
    ADDR_TUNERAXI_BTM_1_V_DATA_0 = 7'h48,
    ADDR_TUNERAXI_BTM_1_V_CTRL   = 7'h4c,
    ADDR_TUNERAXI_BTM_2_V_DATA_0 = 7'h50,
    ADDR_TUNERAXI_BTM_2_V_CTRL   = 7'h54,
    ADDR_TUNERAXI_BTM_3_V_DATA_0 = 7'h58,
    ADDR_TUNERAXI_BTM_3_V_CTRL   = 7'h5c,
    ADDR_TUNERAXI_BTM_4_V_DATA_0 = 7'h60,
    ADDR_TUNERAXI_BTM_4_V_CTRL   = 7'h64,
    ADDR_OUTPUT1AXI_V_DATA_0     = 7'h68,
    ADDR_OUTPUT1AXI_V_CTRL       = 7'h6c,
    ADDR_OUTPUT2AXI_V_DATA_0     = 7'h70,
    ADDR_OUTPUT2AXI_V_CTRL       = 7'h74,
    ADDR_STARTAXI_V_DATA_0       = 7'h78,
    ADDR_STARTAXI_V_CTRL         = 7'h7c,
    WRIDLE                       = 2'd0,
    WRDATA                       = 2'd1,
    WRRESP                       = 2'd2,
    WRRESET                      = 2'd3,
...
//------------------------Local signal-------------------
    ...
    reg  [31:0]                   int_tuneraxi_top_1_V = 'b0;
    reg  [31:0]                   int_tuneraxi_top_2_V = 'b0;
    reg  [31:0]                   int_tuneraxi_top_3_V = 'b0;
    reg  [31:0]                   int_tuneraxi_top_4_V = 'b0;
    reg  [31:0]                   int_tuneraxi_btm_1_V = 'b0;
    reg  [31:0]                   int_tuneraxi_btm_2_V = 'b0;
    reg  [31:0]                   int_tuneraxi_btm_3_V = 'b0;
    reg  [31:0]                   int_tuneraxi_btm_4_V = 'b0;
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_TUNERAXI_TOP_1_V_DATA_0: begin
                    rdata <= int_tuneraxi_top_1_V[31:0];
                end
                ADDR_TUNERAXI_TOP_2_V_DATA_0: begin
                    rdata <= int_tuneraxi_top_2_V[31:0];
                end
                ADDR_TUNERAXI_TOP_3_V_DATA_0: begin
                    rdata <= int_tuneraxi_top_3_V[31:0];
                end
                ADDR_TUNERAXI_TOP_4_V_DATA_0: begin
                    rdata <= int_tuneraxi_top_4_V[31:0];
                end
                ADDR_TUNERAXI_BTM_1_V_DATA_0: begin
                    rdata <= int_tuneraxi_btm_1_V[31:0];
                end
                ADDR_TUNERAXI_BTM_2_V_DATA_0: begin
                    rdata <= int_tuneraxi_btm_2_V[31:0];
                end
                ADDR_TUNERAXI_BTM_3_V_DATA_0: begin
                    rdata <= int_tuneraxi_btm_3_V[31:0];
                end
                ADDR_TUNERAXI_BTM_4_V_DATA_0: begin
                    rdata <= int_tuneraxi_btm_4_V[31:0];
                end
...
assign tuneraxi_top_1_V = int_tuneraxi_top_1_V;
assign tuneraxi_top_2_V = int_tuneraxi_top_2_V;
assign tuneraxi_top_3_V = int_tuneraxi_top_3_V;
assign tuneraxi_top_4_V = int_tuneraxi_top_4_V;
assign tuneraxi_btm_1_V = int_tuneraxi_btm_1_V;
assign tuneraxi_btm_2_V = int_tuneraxi_btm_2_V;
assign tuneraxi_btm_3_V = int_tuneraxi_btm_3_V;
assign tuneraxi_btm_4_V = int_tuneraxi_btm_4_V;
...
// int_tuneraxi_top_1_V[31:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_tuneraxi_top_1_V[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_TUNERAXI_TOP_1_V_DATA_0)
            int_tuneraxi_top_1_V[31:0] <= (WDATA[31:0] & wmask) | (int_tuneraxi_top_1_V[31:0] & ~wmask);
    end
end

// int_tuneraxi_top_2_V[31:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_tuneraxi_top_2_V[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_TUNERAXI_TOP_2_V_DATA_0)
            int_tuneraxi_top_2_V[31:0] <= (WDATA[31:0] & wmask) | (int_tuneraxi_top_2_V[31:0] & ~wmask);
    end
end

// int_tuneraxi_top_3_V[31:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_tuneraxi_top_3_V[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_TUNERAXI_TOP_3_V_DATA_0)
            int_tuneraxi_top_3_V[31:0] <= (WDATA[31:0] & wmask) | (int_tuneraxi_top_3_V[31:0] & ~wmask);
    end
end

// int_tuneraxi_top_4_V[31:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_tuneraxi_top_4_V[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_TUNERAXI_TOP_4_V_DATA_0)
            int_tuneraxi_top_4_V[31:0] <= (WDATA[31:0] & wmask) | (int_tuneraxi_top_4_V[31:0] & ~wmask);
    end
end

// int_tuneraxi_btm_1_V[31:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_tuneraxi_btm_1_V[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_TUNERAXI_BTM_1_V_DATA_0)
            int_tuneraxi_btm_1_V[31:0] <= (WDATA[31:0] & wmask) | (int_tuneraxi_btm_1_V[31:0] & ~wmask);
    end
end

// int_tuneraxi_btm_2_V[31:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_tuneraxi_btm_2_V[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_TUNERAXI_BTM_2_V_DATA_0)
            int_tuneraxi_btm_2_V[31:0] <= (WDATA[31:0] & wmask) | (int_tuneraxi_btm_2_V[31:0] & ~wmask);
    end
end

// int_tuneraxi_btm_3_V[31:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_tuneraxi_btm_3_V[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_TUNERAXI_BTM_3_V_DATA_0)
            int_tuneraxi_btm_3_V[31:0] <= (WDATA[31:0] & wmask) | (int_tuneraxi_btm_3_V[31:0] & ~wmask);
    end
end

// int_tuneraxi_btm_4_V[31:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_tuneraxi_btm_4_V[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_TUNERAXI_BTM_4_V_DATA_0)
            int_tuneraxi_btm_4_V[31:0] <= (WDATA[31:0] & wmask) | (int_tuneraxi_btm_4_V[31:0] & ~wmask);
    end
end
