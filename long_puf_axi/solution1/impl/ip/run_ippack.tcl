...
set Library     "hls"
set IPName      "long_puf_axi_interface"
set Version     "1.0"
set DisplayName "Long_puf_axi_interface"
set Revision    "1903171639"
...
## Variables
set Top "long_puf_axi_interface"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 challenge1axi_V W 0x0 "Data signal of challenge1axi_V" {{0 4 challenge1axi_V W 0 "Bit 3 to 0 Data signal of challenge1axi_V"} {4 28 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 challenge2axi_V W 0x0 "Data signal of challenge2axi_V" {{0 4 challenge2axi_V W 0 "Bit 3 to 0 Data signal of challenge2axi_V"} {4 28 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 responseaxi_V R 0x0 "Data signal of responseaxi_V" {{0 8 responseaxi_V R 0 "Bit 7 to 0 Data signal of responseaxi_V"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x24 responseaxi_V_ctrl R 0x0 "Control signal of responseaxi_V" {{0 1 responseaxi_V_ap_vld R 0 "Control signal responseaxi_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 tuneraxi_top_1_V W 0x0 "Data signal of tuneraxi_top_1_V" {{0 32 tuneraxi_top_1_V W 0 "Bit 31 to 0 Data signal of tuneraxi_top_1_V"}}} {0x30 tuneraxi_top_2_V W 0x0 "Data signal of tuneraxi_top_2_V" {{0 32 tuneraxi_top_2_V W 0 "Bit 31 to 0 Data signal of tuneraxi_top_2_V"}}} {0x38 tuneraxi_top_3_V W 0x0 "Data signal of tuneraxi_top_3_V" {{0 32 tuneraxi_top_3_V W 0 "Bit 31 to 0 Data signal of tuneraxi_top_3_V"}}} {0x40 tuneraxi_top_4_V W 0x0 "Data signal of tuneraxi_top_4_V" {{0 32 tuneraxi_top_4_V W 0 "Bit 31 to 0 Data signal of tuneraxi_top_4_V"}}} {0x48 tuneraxi_btm_1_V W 0x0 "Data signal of tuneraxi_btm_1_V" {{0 32 tuneraxi_btm_1_V W 0 "Bit 31 to 0 Data signal of tuneraxi_btm_1_V"}}} {0x50 tuneraxi_btm_2_V W 0x0 "Data signal of tuneraxi_btm_2_V" {{0 32 tuneraxi_btm_2_V W 0 "Bit 31 to 0 Data signal of tuneraxi_btm_2_V"}}} {0x58 tuneraxi_btm_3_V W 0x0 "Data signal of tuneraxi_btm_3_V" {{0 32 tuneraxi_btm_3_V W 0 "Bit 31 to 0 Data signal of tuneraxi_btm_3_V"}}} {0x60 tuneraxi_btm_4_V W 0x0 "Data signal of tuneraxi_btm_4_V" {{0 32 tuneraxi_btm_4_V W 0 "Bit 31 to 0 Data signal of tuneraxi_btm_4_V"}}} {0x68 output1axi_V R 0x0 "Data signal of output1axi_V" {{0 8 output1axi_V R 0 "Bit 7 to 0 Data signal of output1axi_V"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x6c output1axi_V_ctrl R 0x0 "Control signal of output1axi_V" {{0 1 output1axi_V_ap_vld R 0 "Control signal output1axi_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x70 output2axi_V R 0x0 "Data signal of output2axi_V" {{0 8 output2axi_V R 0 "Bit 7 to 0 Data signal of output2axi_V"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x74 output2axi_V_ctrl R 0x0 "Control signal of output2axi_V" {{0 1 output2axi_V_ap_vld R 0 "Control signal output2axi_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x78 startaxi_V W 0x0 "Data signal of startaxi_V" {{0 1 startaxi_V W 0 "Bit 0 to 0 Data signal of startaxi_V"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
