...
(* CORE_GENERATION_INFO="long_puf_axi_interface,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=1.000000,HLS_SYN_LAT=0,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=409,HLS_SYN_LUT=618}" *)
...
reg tuner_top_1_V_ap_vld;
reg tuner_top_2_V_ap_vld;
reg tuner_top_3_V_ap_vld;
reg tuner_top_4_V_ap_vld;
reg tuner_btm_1_V_ap_vld;
reg tuner_btm_2_V_ap_vld;
reg tuner_btm_3_V_ap_vld;
reg tuner_btm_4_V_ap_vld;
...
wire   [31:0] tuneraxi_top_1_V;
wire   [31:0] tuneraxi_top_2_V;
wire   [31:0] tuneraxi_top_3_V;
wire   [31:0] tuneraxi_top_4_V;
wire   [31:0] tuneraxi_btm_1_V;
wire   [31:0] tuneraxi_btm_2_V;
wire   [31:0] tuneraxi_btm_3_V;
wire   [31:0] tuneraxi_btm_4_V;
reg    output1axi_V_ap_vld;
reg    output2axi_V_ap_vld;
wire   [0:0] startaxi_V;
reg    ap_rst_n_inv;

long_puf_axi_interface_AXILiteS_s_axi #(
    .C_S_AXI_ADDR_WIDTH( C_S_AXI_AXILITES_ADDR_WIDTH ),
    .C_S_AXI_DATA_WIDTH( C_S_AXI_AXILITES_DATA_WIDTH ))
long_puf_axi_interface_AXILiteS_s_axi_U(
...
always @ (*) begin
    if ((ap_start == 1'b1)) begin
        tuner_btm_1_V_ap_vld = 1'b1;
    end else begin
        tuner_btm_1_V_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if ((ap_start == 1'b1)) begin
        tuner_btm_2_V_ap_vld = 1'b1;
    end else begin
        tuner_btm_2_V_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if ((ap_start == 1'b1)) begin
        tuner_btm_3_V_ap_vld = 1'b1;
    end else begin
        tuner_btm_3_V_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if ((ap_start == 1'b1)) begin
        tuner_btm_4_V_ap_vld = 1'b1;
    end else begin
        tuner_btm_4_V_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if ((ap_start == 1'b1)) begin
        tuner_top_1_V_ap_vld = 1'b1;
    end else begin
        tuner_top_1_V_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if ((ap_start == 1'b1)) begin
        tuner_top_2_V_ap_vld = 1'b1;
    end else begin
        tuner_top_2_V_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if ((ap_start == 1'b1)) begin
        tuner_top_3_V_ap_vld = 1'b1;
    end else begin
        tuner_top_3_V_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if ((ap_start == 1'b1)) begin
        tuner_top_4_V_ap_vld = 1'b1;
    end else begin
        tuner_top_4_V_ap_vld = 1'b0;
    end
end
...
assign tuner_btm_1_V = tuneraxi_btm_1_V;

assign tuner_btm_2_V = tuneraxi_btm_2_V;

assign tuner_btm_3_V = tuneraxi_btm_3_V;

assign tuner_btm_4_V = tuneraxi_btm_4_V;

assign tuner_top_1_V = tuneraxi_top_1_V;

assign tuner_top_2_V = tuneraxi_top_2_V;

assign tuner_top_3_V = tuneraxi_top_3_V;

assign tuner_top_4_V = tuneraxi_top_4_V;

endmodule //long_puf_axi_interface
